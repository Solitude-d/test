...
// Source: webook/internal/service/bigCode.go
...
import (
	context "context"
	reflect "reflect"
	domain "test/webook/internal/domain"
...
func (m *MockUserService) Edit(ctx context.Context, id int64, name, birth, synopsis string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Edit", ctx, id, name, birth, synopsis)
	ret0, _ := ret[0].(error)
	return ret0
}

// Edit indicates an expected call of Edit.
func (mr *MockUserServiceMockRecorder) Edit(ctx, id, name, birth, synopsis interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Edit", reflect.TypeOf((*MockUserService)(nil).Edit), ctx, id, name, birth, synopsis)
}
